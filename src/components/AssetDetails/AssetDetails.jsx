...
export default function AssetDetails() {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const rows = [
        { asset: isAr ? asset?.nameAr : asset?.nameEn, amount: formatCurrency(invoice.amount) },
        { asset: t('إجمالي مبلغ الشراء', 'Total Purchase Amount'), amount: formatCurrency(invoice.amount) },
      ];
